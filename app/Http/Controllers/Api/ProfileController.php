...
class ProfileController extends Controller
{
    ...
    public function index($user_id)
    {
        if($this->valid_token == 0) {
            ...
            return [
                'unRelatedUsersIds' => $unRelatedUsersIds,
                'myProfile' => $myProfile,
                'profileId' => $profileId,
                'friends' => $friends,
                'followers' => $followers, 'followings' => $followings,
                'Myfollowers' => $Myfollowers, 'Myfollowings' => $Myfollowings, 'MyFriends' => $myProfile,
                'pending_send' => $pending_send, 'pending_receive' => $pending_receive,
                'firendship_state' => $firendship_state, 'following_state' => $following_state,
