                ...
                <div id="all-groups" class=" tabcontent" >
                  <div  class="row ">
                      @foreach($all_groups as $all_group)
                        <div class="col-lg-4">
                            <div class="card">
                                <a href="/groups/{{$all_group->id}}">
                                    <img src="{{asset('assets/images/groups/profile')}}/{{$all_group->profile_image}}" class="card-img-top" width="200" height="200" alt="...">
                                </a>
                                <div class="d-flex justify-content-between">
                                    <div class="card-body">
                                        <a href="groups/{{$all_group->id}}" style="color:black !important">
