                    ...
                    <div  class="row ">
                        @foreach($my_pages as $my_page)
                          <div class="col-lg-4" id="{{$my_page->page->id}}|0">
                              <div class="card">
                                  <a href="/pages/{{$my_page->page->id}}">
                                      <img src="{{asset('assets/images/pages/profile')}}/{{$my_page->page->profile_image}}" class="card-img-top" width="200" height="200" alt="...">
                                  </a>
                                  <div class="d-flex justify-content-between">
                                      <div class="card-body">
                                          <a href="pages/{{$my_page->page->id}}" style="color:black !important">
