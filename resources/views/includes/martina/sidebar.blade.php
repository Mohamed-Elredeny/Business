            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        ...
                        <span>Admin apnel</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="true">
                
                        <li><a href="javascript: void(0);" class="has-arrow">Requests</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <ul class="sub-menu" aria-expanded="true">
                
                                    <li><a href="javascript: void(0);" class="has-arrow">Posts</a>
                                        <ul class="sub-menu" aria-expanded="true">
                                            <li><a href="javascript: void(0);">Pending</a></li>
                                            <li><a href="javascript: void(0);">Accepted</a></li>
                                            <li><a href="javascript: void(0);">Refused</a></li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <!-- Categories -->
                <li>
                    <a href="{{ route('categories.index') }}" class="has-arrow waves-effect">
                        <i class="dripicons-network-1"></i>
                 ...
                 <!-- Posts -->
                 <li>
                    <a href="{{ route('posts.index') }}" class="has-arrow waves-effect">
                        <i class="dripicons-network-1"></i>
                        <span>Posts</span>
                    </a>
                    {{-- <ul class="sub-menu" aria-expanded="true">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li><a href="javascript: void(0);" class="has-arrow">Comments</a>
                            <ul class="sub-menu" aria-expanded="true">
                                <ul class="sub-menu" aria-expanded="true">
                ...
                <li>
                    <a href="{{route('badwords.index')}}" class="waves-effect">
